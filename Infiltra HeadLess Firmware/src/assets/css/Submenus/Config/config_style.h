#ifndef ASSETS_CSS_CONFIG_STYLE_H
#define ASSETS_CSS_CONFIG_STYLE_H

const char CONFIG_STYLE_CSS[] PROGMEM = R"rawliteral(@import url('https://fonts.googleapis.com/css2?family=Syncopate:wght@400;700&family=Space+Mono:wght@400;700&family=Orbitron:wght@400;500;700&display=swap');
