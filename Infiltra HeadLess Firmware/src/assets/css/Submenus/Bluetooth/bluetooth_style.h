#ifndef ASSETS_CSS_BLUETOOTH_STYLE_H
#define ASSETS_CSS_BLUETOOTH_STYLE_H

const char BLUETOOTH_STYLE_CSS[] PROGMEM = R"rawliteral(@import url('https://fonts.googleapis.com/css2?family=Syncopate:wght@400;700&family=Space+Mono:wght@400;700&family=Orbitron:wght@400;500;700&display=swap');
